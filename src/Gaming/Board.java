...
public class Board extends JPanel implements ActionListener {
    ...
    private void doAnim() {
//doAnim() counts the pacmanAnimPos variable which determines what pacman image is drawn
        pacAnimCount--;

        if (pacAnimCount <= 0) {
            pacAnimCount = PAC_ANIM_DELAY;
            pacmanAnimPos = pacmanAnimPos + pacAnimDir;
//PAC_ANIM_DELAY constant which makes the animation a bit slower. 
...
//for checking any points left for the Pacman to eat.
...
/*this method for The ghosts move one square and then 
...
/*This line determines where the ghost is located; in which position of square. There are 225 theoretical positions.*/
                count = 0;
